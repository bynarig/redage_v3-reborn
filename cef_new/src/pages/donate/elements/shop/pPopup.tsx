...
interface PPopupProps {
  popupData: CharacterItem;
  setPopup: (value: null) => void;
}

const PPopup: React.FC<PPopupProps> = ({ popupData, setPopup }) => {
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="bg-gray-800/90 rounded-lg shadow-lg p-4 hover:shadow-xl transition-shadow flex flex-col md:flex-row">
