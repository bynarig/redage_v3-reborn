<script>
    ...
    import {selectedImage, selectedImageFunc} from "#/store/player/hudevo/phonenew/stores";
    import {messageType} from "#/store/player/hudevo/phonenew/components/messages/data";
    ...
    const maxSymbol = 150;
    import { onInputFocus, onInputBlur } from "#/store/player/hudevo/phonenew/data";
</script>
